...
def output_stats(trackers, output_dir='output', prefix=''):
    ...
    with open(os.path.join(output_dir, prefix + 'cloud_stats.txt'), 'w') as f:
        ...
        plt.savefig(os.path.join(output_dir, prefix + 'lifetime_hist.png'))

        plt.figure('linear_lifetime_hist')
        plt.xlabel('Lifetime (min)')
        plt.ylabel('Frequency of lifecycle')
        plt.legend(loc='upper right')
        plt.savefig(os.path.join(output_dir, prefix + 'linear_lifetime_hist.png'))

        plt.figure('log_lifetime_hist')
        plt.xlabel('Lifetime (min)')
        plt.ylabel('Frequency of lifecycle')
        plt.legend(loc='upper right')
        plt.savefig(os.path.join(output_dir, prefix + 'log_lifetime_hist.png'))

        plt.figure('log_linear_lifetime_hist')
        plt.xlabel('Lifetime (min)')
        plt.ylabel('Frequency of lifecycle')
        plt.legend(loc='upper right')
        plt.savefig(os.path.join(output_dir, prefix + 'log_linear_lifetime_hist.png'))
